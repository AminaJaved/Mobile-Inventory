...
namespace WebApplication1.Controllers
{
    public class AdminController : Controller
    {
        ...
        public ActionResult Export1()
        {
            ...
            rd1.Load(Path.Combine(Server.MapPath("~/Reports/OrderCrystalReport.rpt")));
        ...
        {
            ReportDocument rd1 = new ReportDocument();
            rd1.Load(Path.Combine(Server.MapPath("~/Reports/ProductCrystalReport.rpt")));
            rd1.SetDataSource(db.Products.Select(a => new
            {
